  ...
  const Card = ({ children, className = "", variant = "default" }: any) => {
    ...
    return (
      ...
      >
        ...
        {variant === "success" && (
          <div className="absolute inset-0 bg-gradient-to-br from-green-500 via-emerald-600 to-teal-500" />
        )}
    ...
    return (
      <div className="min-h-screen relative">
        ...
        <div className="relative z-10 p-4 sm:p-6 lg:p-8">
          {/* Navigation & Header */}
          <div className="max-w-5xl mx-auto flex justify-between sm:justify-start sm:gap-4 mb-6">
          ...
          <header className="text-center mb-8 max-w-5xl mx-auto">
            <div className="inline-flex items-center justify-center p-3 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 rounded-full mb-4 shadow-2xl">
